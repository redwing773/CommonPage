...
(function($) {
	...
	$.fn.timepicki = function(options) {
		...
		return this.each(function() {
			...
			ele_hei += 10;
			$(ele).wrap("<div class='time_pick' style='display: inline-block;'>");
			...
			var new_ele = $(
				"<div class='timepicker_wrap " + settings.custom_classes + "' style='position:absolute; display:none;'>" +
			...
			function open_timepicki() {
				...
				var top = ele.position().top + ele_hei + $(window).scrollTop();
				
				var $parent = ele;
				while(true) {
					$parent = $parent.parent();
					top += $parent.scrollTop();
					if ($parent.prop("tagName") === 'BODY') break;
				}
