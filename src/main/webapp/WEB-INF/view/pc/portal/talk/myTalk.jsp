...
<t:noLayout>
	<jsp:attribute name="script_file">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/api/consult_api.js?ver=2021151122"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/api/linker_api.js?ver=20210319"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/api/mojiboard_api.js?ver=20211021"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/api/portaltalk_api.js?ver=20221102"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/apps/js/search/list.js?ver=20221101"></script>
        <script type="text/javascript" src="${pageContext.request.contextPath}/apps/js/search/log.js?ver=2022032201"></script>
 		<script type="text/javascript">
 		<%-- 사용자 정보 --%>
 		var userHipId = tms.getCookie("hipid");
 		var systemMode = properties.getSystemMode();
 		var token = tms.getCookie("linker_token");
		var reload = Number(tms.getParameterByName("reload"));
 		var onceReload = true;
		var once = true;
		var mentorYn = "N";
		var userMentorYn = "N";
		...
		var endPage2 = false;
 		...
 		$(function(){
			...
			$("#divList").scroll(function(){
				if ((chkPage2 <= currentPaging2) && !endPage2 && $(this).scrollTop() + $(this).height() >= $(this).prop('scrollHeight') - 300) {
			...
			$(window).scroll(function(){
				if ((chkPage2 <= currentPaging2) && !endPage2 &&  $(window).scrollTop() + $(window).height() >= $(document).height() - 182) {
					getMyTalkList(currentPaging2, limit, ".awl_main_mojimylist");
				}
		...
		var moreContentFn = function(talkNo) {
			if(gnbParams.indexOf("?") == 0) {
				location.href = contextPath + "/page/portal/talk/detail/"+talkNo+"?prev=myTalk&" + gnbParams.substr(1);
			}else {
				location.href = contextPath + "/page/portal/talk/detail/"+talkNo+"?prev=myTalk";
			}
		};
...
<%--					</div>--%>
			...
			<div class="awl_header_b" style="max-width: 384px;margin: 0 auto;padding-left: 16px;">
				...
				<a href="javascript:void(0);" id="btn_mytalk" class="moji_tab on" data-tab="0">내글</a>
			</div>
		</div>
		<div style="display: flex; justify-content: center; background-color: #F7F9FF; height: calc(100vh);">
			<div id="divList" style="position:absolute;top:100px;height:calc(100vh - 100px); overflow:auto;">
				...
				<div class="awl_wrap moji_mylist" style="background: none;">
					<div class="awl_content">
							<%-- 마이톡 리스트 --%>
						<ul class="awl_main_mojimylist moji_talk_list" style="padding:20px 16px 88px 16px;"></ul>
					</div>
				</div>
			</div>
		</div>
